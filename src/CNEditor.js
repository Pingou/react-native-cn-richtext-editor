...
export default class CNEditor extends Component {
        ...
        try {
            ...
            switch (message.type) {
                ...
                case 'selectedStyles':
                    ...
                    break;
                    case 'selectedColor':                        
                        this.onSelectedColorChanged(message.data);
                    break;
                    case 'save':                        
                        this.onSave(message.data);
                    break;
    ...
    onSelectedColorChanged = (color) => {
        if (this.props.onSelectedColorChanged) {
            this.props.onSelectedColorChanged(color);
        }
    }
    ...
    applyToolbar = (tool, value = null) => {
        ...
        if(tool === 'red' || tool === 'green'  || tool === 'blue'  || tool === 'black') {
            ...
            jsonString = JSON.stringify({ type: 'toolbar', command: tool , value: value   });
        }
        else {
